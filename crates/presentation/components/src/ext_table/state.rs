...
pub struct TableState<D: TableDelegate> {
    ...
    pub horizontal_scroll_handle: crate::virtual_list::VirtualListScrollHandle,
    ...
    D: TableDelegate,
{
    pub fn new(delegate: D, _: &mut Window, cx: &mut Context<Self>) -> Self {
        let mut this = Self {
            ...
            horizontal_scroll_handle: crate::virtual_list::VirtualListScrollHandle::new(),
    ...
    fn calculate_visible_leaf_col_range(
        ...
        let mut cumulative = left_spacer;

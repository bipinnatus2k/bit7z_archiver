...
use gpui::{div, AnyElement, App, AppContext, Context, Entity, FocusHandle, InteractiveElement as _, IntoElement, MouseButton, ParentElement as _, Render, SharedString, Styled as _, Subscription, Window};
use gpui_component::{
    menu::AppMenuBar,
    TitleBar,
    WindowExt as _,

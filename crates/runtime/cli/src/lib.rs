...
pub fn run_cli(repo: Arc<dyn ArchiveRepository>, cli: &Cli) {
    ...
    match cmd {
        ...
        Commands::Delete { path, indices, password } => {
            ...
            let uc = bit7z_app_archive::delete::DeleteEntriesUseCase::new(repo.clone());
        ...
        Commands::Rename { path, index, name, password } => {
            ...
            let uc = bit7z_app_archive::rename::RenameEntryUseCase::new(repo.clone());
        ...
        Commands::NewFolder { path, folder_path, password } => {
            ...
            match bit7z_app_archive::new_folder::new_folder(repo_clone, &mut handle, &folder_path, pw.as_ref()) {

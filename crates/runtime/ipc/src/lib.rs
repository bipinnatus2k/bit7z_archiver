...
// ---------------------------------------------------------------------------
// IPC transport for CLI→GUI communication (migrated from ipc_connect.rs)
// Uses a simple TCP socket on localhost with a port derived from the archive
// path hash. This avoids platform-specific dependencies.
// ---------------------------------------------------------------------------

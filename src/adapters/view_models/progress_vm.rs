use crate::adapters::tray::TrayCommand;
use crate::application::progress::ProgressReceiver;
...
pub struct ProgressState {
    ...
    /// Sender to the tray icon for progress updates when the dialog is hidden.
    pub tray_sender: Option<Sender<TrayCommand>>,
    /// True when the user pressed Hide — forward progress to the tray.

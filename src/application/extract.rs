...
mod tests {
    use super::*;
    use crate::domain::archive::{ArchiveEntry, ArchiveFormat, ArchiveHandle, ChangeSet, EncryptionConfig, Page, Password, TestResult};
    ...
    struct NoopNotifier;
    impl crate::domain::repository::ProgressNotifier for NoopNotifier {
        fn notify(&self, _: &crate::domain::repository::ProgressUpdate) {}
    }
    ...
    fn test_extract_invalid_index_returns_error() {
        ...
        impl ArchiveRepository for FailExtract {
            ...
            fn apply_changes(&self, _: &ArchiveHandle, _: &ExecutionPlan, _: &crate::domain::repository::WriteOptions) -> Result<(), ArchiveError> { Err(ArchiveError::UnsupportedOperation) }
